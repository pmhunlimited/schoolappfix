						...
						<form method="post">
							<div
								...
								<select onchange="pageListNumber();" id="page_list_number" class="form-select">
									<option <?php if (trim(strip_tags($_GET["pnum"])) == 10) {
										echo "selected";
									} ?> value="10">10
									</option>
									<option <?php if (trim(strip_tags($_GET["pnum"])) == 25) {
										echo "selected";
									} ?> value="25">25
									</option>
									<option <?php if (trim(strip_tags($_GET["pnum"])) == 50) {
										echo "selected";
									} ?> value="50">50
									</option>
									<option <?php if (trim(strip_tags($_GET["pnum"])) == 100) {
										echo "selected";
									} ?> value="100">100
									</option>
								</select>
							...
							<span class="color-7 mobile-font-size-16 system-font-size-18">Showing
								...
								<?php echo ($page_pnum * $current_page_no); ?> of <?php echo $count_school_listed; ?> entries</span>
						...
						<form method="post" enctype="multipart/form-data">
							<table
								...
								<tr>
									...
									<td class="mobile-width-10 system-width-25"></td>
									<td>Motto</td>
									<td>Address</td>
									<td>Mobile</td>
									<td>Login</td>
								...
								if (mysqli_num_rows($select_all_school_table_lists) > 0) {
									...
									<td>' . $school_details["school_name"] . '<br><span class="color-5">' . $school_details["email"] . '</span></td>
           							<td>' . $school_details["school_motto"] . '</td>
									<td>' . $school_details["school_address"] . '</td>
									<td>' . $school_details["school_phone_number"] . '</td>
									<td><span style="text-decoration: underline; color: var(--color-7); cursor: pointer;" onclick="logAsUser(`school-admin`,`' . $school_details["school_id_number"] . '`);">Login</span></td>
									<td>
										<img onclick="return popUpAlert([`' . $school_view_link . '`,``,`' . $school_edit_link . '`,``],[`View School Details`,``,`Edit School`,``]);" src="imgfile/More.png" style="cursor: pointer;" class="onhover-bg-color-6 mobile-width-40 system-width-30" onclick="schoolDetail(' . $school_details["email"] . ',' . $school_details["school_id_number"] . ',' . $school_details["school_phone_number"] . ',' . $school_details["school_motto"] . ',' . $school_details["school_address"] . ',' . $school_details["city"] . ',' . $school_details["state"] . ',' . $school_details["country"] . ')" />
									</td>
									</tr>';
									}
								}
							...
							<button name="delete-school" type="submit" id="delSchool" style="display: none;"
			...
			<center>
				...
				<?php if (((isset($_GET['edit'])) && (trim(strip_tags($_GET['edit'])) !== "") && (mysqli_num_rows($edit_school_checkmate) == 1)) || ((!isset($_GET['edit'])) && (trim(strip_tags($_GET['edit'])) == "") && (isset($_GET['tab'])))) { ?>
					<form method="post" enctype="multipart/form-data">
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="name" value="<?php echo $edit_school_detail['school_name']; ?>" type="text" placeholder=""
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="motto" value="<?php echo $edit_school_detail['school_motto']; ?>" type="text"
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="address" value="<?php echo $edit_school_detail['school_address']; ?>" type="text"
								placeholder="" class="form-input" required />
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-first" value="<?php echo $edit_school_moderator_detail['firstname']; ?>" type="text"
								placeholder="" class="form-input" required />
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-last" value="<?php echo $edit_school_moderator_detail['lastname']; ?>" type="text"
								placeholder="" class="form-input" required />
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-phone" value="<?php echo $edit_school_moderator_detail['phone_number']; ?>" type="text"
								pattern="[0-9]{13}" title="Phone number include Country Code without (+)" placeholder=""
								class="form-input" required />
						...
						<div
							...
							<select name="mod-gender" class="form-select" required>
								...
								<option value="male" <?php if ($edit_school_moderator_detail['gender'] == "male") {
									echo 'selected';
								} ?>>Male</option>
								<option value="female" <?php if ($edit_school_moderator_detail['gender'] == "female") {
									echo 'selected';
								} ?>>Female</option>
							</select>
						...
						<div
							...
							<select name="mod-marital" class="form-select" required>
								...
								<option value="single" <?php if ($edit_school_moderator_detail['marital_status'] == "single") {
									echo 'selected';
								} ?>>Single</option>
								<option value="married" <?php if ($edit_school_moderator_detail['marital_status'] == "married") {
									echo 'selected';
								} ?>>Married</option>
								<option value="divorced" <?php if ($edit_school_moderator_detail['marital_status'] == "single") {
									echo 'divorced';
								} ?>>Divorced</option>
							</select>
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-city" value="<?php echo $edit_school_moderator_detail['city']; ?>" type="text"
								placeholder="" class="form-input" required />
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-state" value="<?php echo $edit_school_moderator_detail['state']; ?>" type="text"
								placeholder="" class="form-input" required />
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<select name="mod-currency" class="form-select" required>
								<option disabled hidden selected value="">Select Currency</option>
								<?php
								foreach ($countries_with_currencies as $currency => $country_name) {
									$currency = strtoupper($currency);
									// Check if the currency matches the currency in PHP itself
									$selected = (strtolower(trim($edit_school_detail['currency'])) == strtolower(trim($currency))) ? 'selected' : '';
									echo '<option value="' . htmlspecialchars($currency, ENT_QUOTES) . '" ' . $selected . '>' . htmlspecialchars($country_name, ENT_QUOTES) . ' (' . $currency . ')</option>';
								}
								?>
							</select>
							<span class="form-span mobile-font-size-12 system-font-size-14">Currency*</span>
						</div>

						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<select name="mod-language" class="form-select" required>
								<option disabled hidden selected value="">Select Language</option>
								<?php
								foreach ($languages_list_array as $lang_abbr => $languange_name) {
									$lang_abbr = strtolower($lang_abbr);
									// Check if the language matches the language in PHP itself
									$selected = (strtolower(trim($edit_school_detail['language'])) == strtolower(trim($lang_abbr))) ? 'selected' : '';
									echo '<option value="' . htmlspecialchars($lang_abbr, ENT_QUOTES) . '" ' . $selected . '>' . htmlspecialchars($languange_name, ENT_QUOTES) . ' (' . $lang_abbr . ')</option>';
								}
								?>
							</select>
							<span class="form-span mobile-font-size-12 system-font-size-14">Language*</span>
						</div>


						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-home-address" value="<?php echo $edit_school_moderator_detail['home_address']; ?>"
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-office-address" value="<?php echo $edit_school_moderator_detail['office_address']; ?>"
								type="text" placeholder="" class="form-input" required />
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-email" value="<?php echo $edit_school_moderator_detail['email']; ?>" type="email"
								placeholder="" class="form-input" required />
						...
						<div
							class="form-group mobile-width-90 system-width-45 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-2 system-margin-left-2 mobile-margin-right-2 system-margin-right-2">
							<input name="mod-pass" type="password" pattern="[a-zA-Z0-9]{8,}"
						...
						<?php if ((!isset($_GET['edit'])) || (trim(strip_tags($_GET['edit'])) == "") || (mysqli_num_rows($edit_school_checkmate) < 1)) { ?>
							<button style="float: left; clear: both;" name="create-school" type="submit"
						...
						<?php } else { ?>
							<?php if (file_exists("dataimg/school_" . $edit_school_detail["school_id_number"] . ".png")) { ?>
								<img style="float: left; clear: both;"
									src="dataimg/school_<?php echo $edit_school_detail["school_id_number"]; ?>.png"
									class="mobile-width-30 system-width-10 mobile-margin-left-5 system-margin-left-3" /><br>
							<?php } else { ?>
								<img style="float: left; clear: both;" src="imgfile/Student_Future.png"
									class="mobile-width-30 system-width-10 mobile-margin-left-5 system-margin-left-3" /><br>
							<?php } ?>
							<button style="float: left; clear: both;" name="update-school" type="submit"
								class="button-box color-2 bg-4 onhover-bg-color-7 mobile-font-size-14 system-font-size-16 mobile-width-93 system-width-46 mobile-margin-top-2 system-margin-top-2 mobile-margin-bottom-2 system-margin-bottom-2 mobile-margin-left-5 system-margin-left-3 mobile-margin-right-1 system-margin-right-1">
								UPDATE SCHOOL
							</button>
						<?php } ?>
			...
			<div class="container-box bg-2 mobile-width-100 system-width-100 mobile-margin-top-1 system-margin-top-1">
				<center>
					<div style="height: 7.5rem;"
						class="container-box bg-4 mobile-width-96 system-width-96 mobile-margin-top-1 system-margin-top-1">

						<?php if (file_exists("dataimg/school_" . $view_school_detail['school_id_number'] . ".png")) { ?>
							<img style="border-style: solid; float: left; clear: left;"
								src="dataimg/school_<?php echo $view_school_detail['school_id_number']; ?>.png"
								class="bg-2 box-shadow border-radius-30px border-color-2 border-width-6 mobile-width-12 system-width-12 mobile-margin-top-6 system-margin-top-3 mobile-margin-left-5 system-margin-left-3" />
						<?php } else { ?>
							<img style="border-style: solid; float: left; clear: left;" src="imgfile/Student_Future.png"
								class="bg-2 box-shadow border-radius-30px border-color-2 border-width-6 mobile-width-12 system-width-12 mobile-margin-top-6 system-margin-top-3 mobile-margin-left-5 system-margin-left-3" />
						<?php } ?>
						<img style="float: right; clear: right;" src="imgfile/Group.png"
							class="bg-3 mobile-width-0 system-width-12 mobile-margin-top-0 system-margin-top-4 mobile-margin-right-1 system-margin-right-1" />
						<div style="text-align: left; display: inline-block; height: 7.5rem;"
							class="container-box bg-3 mobile-width-78 system-width-69 mobile-margin-top-4 system-margin-top-3 mobile-margin-left-1 system-margin-left-0">
							<!-- Name -->
							<span style="display: inline-block;"
								class="color-2 mobile-font-size-17 system-font-size-25"><?php echo $view_school_detail["school_name"]; ?></span>
							<a href="<?php echo $school_view_edit_link; ?>" style="text-decoration: none;">
								<img style="margin-bottom: -1%;" src="imgfile/edit.png"
									class="mobile-width-8 system-width-4 mobile-margin-top-1 system-margin-top-1 mobile-margin-left-1 system-margin-left-1" /><br />
							</a>

							<!-- Phone -->
							<img style="margin-bottom: -0.5%;" src="imgfile/phone.png"
								class="mobile-width-6 system-width-3 mobile-margin-top-3 system-margin-top-3 mobile-margin-right-0 system-margin-right-0" />
							<span style="display: inline-block;"
								class="color-2 mobile-font-size-14 system-font-size-16 mobile-margin-left-0 system-margin-left-0"><?php echo $view_school_detail["school_phone_number"]; ?></span><br />

							<!-- City -->
							<img style="margin-bottom: -0.5%;" src="imgfile/location.png"
								class="mobile-width-6 system-width-2 mobile-margin-top-3 system-margin-top-3 mobile-margin-right-1 system-margin-right-1" />
							<span style="display: inline-block;"
								class="color-5 mobile-font-size-14 system-font-size-16 mobile-margin-left-0 system-margin-left-0"><?php echo $view_school_detail["city"]; ?></span>
						</div>
					</div>
					<div style=""
						class="container-box bg-3 mobile-width-90 system-width-96 mobile-margin-top-10 system-margin-top-5">
						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-31 mobile-margin-top-3 system-margin-top-0">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">Email
								ID</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_detail["email"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-23 mobile-margin-top-3 system-margin-top-0">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">School ID
								Number</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo "SC/AD/" . $view_school_detail["school_id_number"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-45 mobile-margin-top-3 system-margin-top-0">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">School
								Motto</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_detail["school_motto"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-31 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">School
								Address</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_detail["school_address"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-23 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;"
								class="color-5 mobile-font-size-14 system-font-size-17">City</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_detail["city"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-22 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;"
								class="color-5 mobile-font-size-14 system-font-size-17">State</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_detail["state"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-22 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">Country
								Located</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo Ucwords($view_school_detail["country"]); ?></span>
						</div>

					</div>
					<div style="text-align: left; border-style: solid;"
						class="container-box border-color-5 border-width-1 bg-3 mobile-width-90 system-width-94 mobile-margin-top-3 system-margin-top-3 mobile-padding-top-2 system-padding-top-1 mobile-padding-left-2 system-padding-left-1 mobile-padding-right-2 system-padding-right-1 mobile-padding-bottom-3 system-padding-bottom-2">
						<span style="display: inline-block;" class="color-5 mobile-font-size-16 system-font-size-17">School
							Administrator Information</span><br>
						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-50 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">Full
								Name</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_first_detail["firstname"] . " " . $view_school_first_detail["lastname"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-16 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">Phone
								Number</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_first_detail["phone_number"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-16 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;"
								class="color-5 mobile-font-size-14 system-font-size-17">Gender</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo Ucwords($view_school_first_detail["gender"]); ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-16 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">Marital
								Status</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo Ucwords($view_school_first_detail["marital_status"]); ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-25 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">Home
								Address</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_first_detail["home_address"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-25 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;" class="color-5 mobile-font-size-14 system-font-size-17">Office
								Address</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_first_detail["office_address"]; ?></span>
						</div>
						...
						<div style="text-align: left; display: inline-block;"
							...
							<span style="display: inline-block;"
								class="color-5 mobile-font-size-14 system-font-size-17">City</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_first_detail["city"]; ?></span>
						</div>
						...
						<div style="text-align: left; display: inline-block;"
							...
							<span style="display: inline-block;"
								class="color-5 mobile-font-size-14 system-font-size-17">State</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo $view_school_first_detail["state"]; ?></span>
						</div>

						<div style="text-align: left; display: inline-block;"
							class="container-box bg-3 mobile-width-100 system-width-16 mobile-margin-top-3 system-margin-top-2">
							<span style="display: inline-block;"
								class="color-5 mobile-font-size-14 system-font-size-17">Country</span><br>
							<span style="display: inline-block;"
								class="color-7 mobile-font-size-16 system-font-size-18"><?php echo Ucwords($view_school_first_detail["country"]); ?></span>
						</div>
